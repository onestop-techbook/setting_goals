...
2019年9月、本書の底本となる同人版「ワンストップ目標設定の技術」が発行され、2021年7月、加筆修正を経て商業版が発行されました。このときは(超)長期の目標設定などに関する記述を追加し、さらなるパワーアップを果たしたと信じております。それを前後してしばらく同人版は在庫切れでしたが、今回増刷することにしました。
