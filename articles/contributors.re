...
//embed{
    ...
    \hspace{1ex}
//}
フリーランスの絵を描くWeb デザイナー。『わかばちゃんと学ぶ』シリーズなどを描いています。技術書典7では新刊『マンガでわかるRuby② オブジェクト指向編』を頒布。
...
そうそう、最初のラフイラストでは、実は山の上のゴールは１つだったんです。
それを見た親方さんからの意見「ゴールを２つ描いてほしい」。
「ゴールは１つではない」という意味を持たせたいということでした。
