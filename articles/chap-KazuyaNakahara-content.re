...
是非みていただけたら嬉しいです。
また、大前提として1on1はあくまでも、ツールの一つなので1on1を必ずしもしなければならないわけではない、というわけではありません。
...
特にエンジニアやバックオフィス系については明確な目標がたてづらい性質もあるのでそのあたりは難しいと思います。実際自分もかなり苦労した記憶があります。


その結果、他のタスクを振られたり、障害発生対応などで忙殺するという事象を
何回も何回も繰り返してきました。
...
なぜならば、「部下が主体」という根底があり、それをサポートするメンターの様な方がいて、初めて成り立つのが1on1だと思っております。
