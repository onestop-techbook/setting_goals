...
この章がキャリアに悩んでる人にとって、目標設定の役に立てれば幸いです。
...
この章の目標設定のステップにしたがって、5000兆円を手に入れましょう！
...
「継続的にたのしく生活費以上のお金を稼げる方法を探す」に目標が変わったところで、どんな選択肢があるか情報収集してみます。
...
=== 5.すぐやれそうなもの、うまくいきそうなものから手をつける（最初は数値目標）
...
「会社に仕事のスケジュールを決められるのがイヤ」 → 「フリーランスになりたい」「汎用的なスキルを身につけたい」
...
「仕事で時間がなくなってプライベートの時間が取れないのがイヤ」 → 「タスク管理能力を身につけて生産性をあげたい」「不労所得を増やしたい」
...
=== 4. それが叶えられるためには何をやるべきなのかを情報収集する
とはいっても、その「夢中になれる仕事」が何かはまだわかりません。

まずは自分の興味がある範囲で、2番目の目標である「フリーランスになる」を叶えやすい職業を洗い出しました。
...
しかし画像1枚をつくるのに1週間くらいかかってしまい、「コスパが悪すぎる」と感じてその後はあまり作っていません。
...
月間12万PV程度には成長したので、ある程度向いていたのではと思っています。

WEBデザイン：CSSがむずかしい。WEBデザイナーよりWEBエンジニアの方が稼げると聞いて、方向を転換しました。
...
「小さい成果を出す→うれしい→改善→もっと成果でる→楽しい→続ける」の正のループにしましょう。

月30万円を目指してて月2000円になったら悲しいけど、月1500円を目指してて2000円になれば嬉しく感じられます。
...
「毎日」に縛られて何も考えずにだらだら続けるのは本末転倒です。

「クオリティーを上げる」が目標であれば時間をかけることが本当は必要なのかもしれません。

「ファンを増やす」が目標であれば、成果が出ていないなら別の手法に切り替える必要があります。
...
「失敗したくないからやらない」というのは、やればできたかもしれない「可能性」を残しておきたい言い訳してる状態です。
...
* 今いる外のコミュニティに向けて情報発信したり、それがきっかけで交流したり、人の力を借りられるようになった
* SIerからエンタメ×テクノロジーという自分の興味とスキルがどんぴしゃな会社に転職できた

と、少しづつですが自分の目標に近づいている感じがあります。

転職したことで「フリーランスになる」という目標からは一旦遠のいてしまいました。

しかし、「サービスを伸ばすためにはまず業界での人脈を得て、ビジネススキルを伸ばす必要がある」と考えた結果なので前進はしていると考えています。

事業計画のように自分の人生を設計し続けるのは正直しんどいときもあります。

それでも、「目標」を決めることで「なんか面白いことないかなぁ」と呟くだけの日々から少しづつ抜け出すことができるはずです。
