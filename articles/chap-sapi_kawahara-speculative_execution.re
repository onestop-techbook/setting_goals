...
このようなデータを見るよりも商業出版されている書籍など観察することをススメます。書籍はある一定数の需要予測に基づいて出されているものでありデータとして価値があります。書籍のカテゴリーに注目するのも良いです。2000年ごろは機械学習などはカテゴリーにすらなっていないニッチなカテゴリーでありましたが2017年ぐらいから出版数が増えてカテゴリー化されました。書籍のカテゴリー化は今後の出版されるということで参考になる指標となります。さらに技術書同人誌においては商業出版よりも早い動きを見せるため、技術書同人誌界隈をウォッチすると予測の精度があがります。
